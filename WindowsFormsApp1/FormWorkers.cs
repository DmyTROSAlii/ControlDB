...
namespace WindowsFormsApp1
{
    ...
    public partial class FormWorkers : Form
    {
        private void ReloadData()
        {
            ...
            DataTable tableData = database.GetTableData("workers", oldColumnNames, newColumNames, valueColumns, searchName);
            dataGridViewTable.DataSource = tableData;
        }
        static string searchName;
        static int valueColumns;
        string[] newColumNames = { "id", "Повне ім'я", "Позиція", "Номер бригади", "День народження", "Стать", "Початок роботи", "Звільнення" };
        string[] oldColumnNames = { "id", "full_name", "position", "id_brigade", "birthday", "gender", "start_date", "end_date" };
        public FormWorkers()
        {
            ...
            DataTable tableData = database.GetTableData("workers", oldColumnNames, newColumNames, valueColumns);
            dataGridViewTable.DataSource = tableData;
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            var newForm = new FormInsertWorkers();
        ...
        {
            // Создание новой формы
            var newForm = new FormDeleteWorkers();
        ...
        {
            // Создание новой формы
            var newForm = new FormUpdateWorkers();
