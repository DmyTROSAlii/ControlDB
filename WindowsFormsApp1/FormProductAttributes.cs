...
namespace WindowsFormsApp1
{
    ...
    public partial class FormProductAttributes : Form
    {
        private void ReloadData()
        {
            DataBase database = new DataBase();
            DataTable tableData = database.GetTableData("productattributes", oldColumnNames, newColumNames, valueColumns, searchName);
            dataGridViewTable.DataSource = tableData;
        }
        static string searchName;
        static int valueColumns;
        string[] newColumNames = { "id", "Назва", "Тип продукту", "Тип атрибуту", "Значення" };
        string[] oldColumnNames = { "id", "name", "id_productType", "type", "value" };
        public FormProductAttributes()
        {
            ...
            DataTable tableData = database.GetTableData("productattributes", oldColumnNames, newColumNames, valueColumns);
            dataGridViewTable.DataSource = tableData;
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            var newForm = new FormInsertProductAttributes();
        ...
        {
            // Создание новой формы
            var newForm = new FormDeleteProductAttributes();
        ...
        {
            // Создание новой формы
            var newForm = new FormUpdateProductAttributes();
