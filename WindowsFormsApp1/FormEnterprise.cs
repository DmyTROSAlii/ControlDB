...
namespace WindowsFormsApp1
{
    ...
    public partial class FormEnterprise : Form
    {
        ...
        string[] newColumNames = { "id", "Назва" };
        string[] oldColumnNames = { "id", "name" };
        public FormEnterprise()
        {
            ...
            DataTable tableData = database.GetTableData("enterprise", oldColumnNames, newColumNames, valueColumns);
            dataGridViewTable.DataSource = tableData;
