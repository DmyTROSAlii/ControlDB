...
namespace WindowsFormsApp1
{
    ...
    public partial class FormBrigade : Form
    {
        private void ReloadData()
        {
            ...
            DataTable tableData = database.GetTableData("brigade", oldColumnNames, newColumNames, valueColumns, searchName);
            dataGridViewTable.DataSource = tableData;
        }
        static string searchName;
        static int valueColumns;
        string[] newColumNames = { "id", "Ділянка", "Бригадир", "Кількість робітників" };
        string[] oldColumnNames = { "id", "id_area", "id_foreman", "count_workers" };
        public FormBrigade()
        {
            ...
            DataTable tableData = database.GetTableData("brigade", oldColumnNames, newColumNames, valueColumns);
            dataGridViewTable.DataSource = tableData;
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            var newForm = new FormInsertBrigade();
        ...
        {
            // Создание новой формы
            var newForm = new FormDeleteBrigade();
        ...
        {
            // Создание новой формы
            var newForm = new FormUpdateBrigade();
