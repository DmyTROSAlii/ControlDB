...
namespace WindowsFormsApp1
{
    ...
    public partial class FormWorkcycle : Form
    {
        private void ReloadData()
        {
            DataBase database = new DataBase();
            DataTable tableData = database.GetTableData("workcycle", oldColumnNames, newColumNames, valueColumns, searchName);
            dataGridViewTable.DataSource = tableData;
        }
        static string searchName;
        static int valueColumns;
        string[] newColumNames = { "id", "Тип продукту", "Номер ділянки", "Номер бригади", "Початок", "Кінець", "Статус" };
        string[] oldColumnNames = { "id", "id_productType", "id_area", "id_brigade", "start_date", "end_date", "status" };
        public FormWorkcycle()
        {
            ...
            DataTable tableData = database.GetTableData("workcycle", oldColumnNames, newColumNames, valueColumns);
            dataGridViewTable.DataSource = tableData;
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            var newForm = new FormInsertWorkcycle();
        ...
        {
            // Создание новой формы
            var newForm = new FormDeleteWorkcycle();
        ...
        {
            // Создание новой формы
            var newForm = new FormUpdateWorkcycle();
